...
KTO 数据集需要提供额外的 `kto_tag` 列。详情请参阅 [sharegpt](#sharegpt-%E6%A0%BC%E5%BC%8F)。

### 多模态图像数据集

多模态图像数据集需要提供额外的 `images` 列。详情请参阅 [sharegpt](#sharegpt-%E6%A0%BC%E5%BC%8F)。

### 多模态视频数据集

多模态视频数据集需要提供额外的 `videos` 列。详情请参阅 [sharegpt](#sharegpt-%E6%A0%BC%E5%BC%8F)。
...
尚不支持，请使用 [alpaca](#alpaca-%E6%A0%BC%E5%BC%8F) 格式。
